...
namespace hIKipau {
    ...
    void GameOverState::Init() {
        ...
        readFile.open("/Users/hikipau/CLionProjects/flappy_sanyok/Resources/res/highScore.txt");
        if (readFile.is_open()) {
            while (!readFile.eof()) {
                readFile >> _highScore;
            }
        ...
        std::ofstream writeFile("/Users/hikipau/CLionProjects/flappy_sanyok/Resources/res/highScore.txt");
        ...
        _highScoreText.setFillColor(sf::Color::Green);
